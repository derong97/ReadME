      ...
      <React.Fragment>
        <Navbar className="navbar-bg" variant="dark" expand="lg">
          ...
          >
            ...
            >
              <NavDropdown.Item className="item" onClick = {this.addBookModalOpen}>Add Book</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item className="item" onClick = {this.addReviewModalOpen}>Add Review</NavDropdown.Item>
            </NavDropdown>
            <NavDropdown
              id="navdropdown"
              className="ml-auto"
...
//   let addBookModalShow = false;
//   let addReviewModalShow = false;

//   const addBookModalClose = () => addBookModalShow = false;
//   const addBookModalOpen = () => addBookModalShow = true;

//   const addReviewModalClose = () => addReviewModalShow = false;
//   const addReviewModalOpen = () => addReviewModalShow = true;
