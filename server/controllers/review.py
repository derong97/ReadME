    ...
    def insert_review(self, reviewerID, asin):
        ...
        if reviewer_info != None:
            ...
            try:
                ...
                con.commit()
                return {"message": "Successfully added review for ASIN {}. \nRefresh the Reviews You Added page to check it out!".format(asin)}, 200
            
            except Exception as e:
                return {"message": "Adding of your review for ASIN {} failed. \nEdit your review instead if you have done a review for this book before".format(asin)}, 400
